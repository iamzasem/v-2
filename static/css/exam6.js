...
q1: 'falsch',      // Elon did more than just test robots on the first day; he also spoke with scientists.
q2: 'falsch',      // The moon rocket is only a possibility for future missions, not confirmed for Mars soon.
q3: 'richtig',     // Elon bought six Mars rover prototypes on March 22, as stated.
q4: 'falsch',      // Elon found the simulation exciting, not boring.
q5: 'richtig',     // The weather was bad (rainy) on the afternoon of March 21.
q6: 'falsch',      // Elon plans a trip to Mars next year, not the moon.

q7: 'c',           // Lewis feels exhausted because he works late into the night.
q8: 'b',           // Charles recommends more sleep to be fitter for races.
q9: 'a',           // More sleep leads to Lewis feeling rested and winning a race.
q10: 'c',          // Greta has little time for friends due to her full schedule.
q11: 'a',          // Greta prefers the train to protect the environment.
q12: 'b',          // Greta reduces her travel to three days a week after her mother’s advice.

q13: 'c',          // Beyoncé’s app (Stage Star) fits Jonas’s interest in a singer’s creative process and stage performances.
q14: 'f',          // Taylor Swift’s app (Swift Stories) matches Lara’s need for song analysis and background info.
q15: 'g',          // Ronaldo’s app (Ronaldo Pro) fits Max’s interest in a football star’s success and training tips.
q16: 'a',          // Greta’s app (Green Ideas) suits Sophie’s need for activism and practical environmental tips.
q17: 'e',          // Elon’s app (Musk Vision) matches Tim’s interest in an entrepreneur’s travels and future visions.
q18: 'b',          // Messi’s app (Messi Inside) fits Anna’s need for a sportsman’s techniques and motivation.
q19: '0',          // No app matches Peter’s need for advanced cooking recipes without beginner tips.

q20: 'Nein',       // Sara prioritizes simplicity and comfort over sustainability.
q21: 'Nein',       // Lukas values convenience (E-scooter, online food) over sustainability.
q22: 'Ja',         // Mia prioritizes the environment over comfort (bike, local shopping).
q23: 'Nein',       // Tom explicitly says sustainability doesn’t matter to him; he prefers comfort.
q24: 'Ja',         // Anna focuses on sustainability (less plastic, green energy) over comfort.
q25: 'Nein',       // Paul prefers comfort and technology over environmental concerns.
q26: 'Ja',         // Lisa values sustainability (no single-use plastic, train travel) over comfort.


q27: 'a',          // At 11:00, visitors can participate in cooking workshops.
q28: 'a',          // The festival ends at 19:00.
q29: 'c',          // During the lunch break, food comes from stands or visitors’ own containers.
q30: 'c',          // At 15:00, there are lectures about climate change and nutrition.
    };
